...
- Async: 7 jobs, 1 channels
- Migrations: 9 total, 0 pending
- API: API-only, GraphQL
- Storage: ActiveStorage (1 models with attachments)
- Assets: none, vite, tailwindcss

## Key models (1 total)
- **JobOffer** (2a, 5v) — has_one :html_file_attachment, has_one :html_file_blob
...
- Follow api_only + graphql + service_objects + concerns_models + concerns_controllers + docker + kamal + ci_github_actions + solid_cache + solid_cable + dry_rb + zeitwerk architecture
