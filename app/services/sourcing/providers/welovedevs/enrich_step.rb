...
module Sourcing
  module Providers
    module Welovedevs
      # LLM enrichment for fields not reliably present in WeLoveDevs structured data
      ...
      class EnrichStep < Sourcing::EnrichStep
        ...
        SYSTEM_PROMPT = <<~PROMPT.freeze
          You are a structured data extractor for WeLoveDevs job offers.
          Return ONLY a valid JSON object matching the provided schema.
          Do not include markdown, prose, or explanations.
        PROMPT

        RESPONSE_SCHEMA = {
          name: "WelovedevsOfferEnrichment",
          schema: {
            type: "object",
            properties: {
