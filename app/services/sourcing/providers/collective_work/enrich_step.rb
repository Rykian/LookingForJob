...
module Sourcing
  module Providers
    module CollectiveWork
      # LLM enrichment for fields not reliably present in Collective.work structured data
      # (technologies, seniority, English level, hybrid-day count). Inherits the LLM
      ...
      class EnrichStep < Sourcing::EnrichStep
        ...
        SYSTEM_PROMPT = <<~PROMPT.freeze
          You are a structured data extractor for Collective.work job offers.
          Return ONLY a valid JSON object matching the provided schema.
          Do not include markdown, prose, or explanations.
        PROMPT

        RESPONSE_SCHEMA = {
          name: "CollectiveWorkOfferEnrichment",
          schema: {
            type: "object",
            properties: {
