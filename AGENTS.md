...
- Async: 10 jobs, 1 channels
- Migrations: 16 total, 0 pending
...
- **Commute::Duration** (2a, 4v) — belongs_to :origin_city, belongs_to :destination_city
  scopes: fresh
- **JobOffer** (8a, 5v) — has_one :html_file_attachment, has_one :html_file_blob, belongs_to :commute_city, belongs_to :canonical_offer, has_many :run_job_offers, has_many :runs, has_many :pipeline_errors, has_many :duplicate_offers
